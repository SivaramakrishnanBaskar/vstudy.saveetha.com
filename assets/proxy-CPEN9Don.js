...
class Oe {
    ...
    add(e) {
        return Fe(this.subscriptions, e), () => Be(this.subscriptions, e)
    }
    notify(e, n, s) {
...
function ur(t, e, n, s, i) {
    let o, r, a = 0;
    do r = e + (n - e) / 2, o = Es(r, s, i) - t, o > 0 ? n = r : e = r; while (Math.abs(o) > ar && ++a < lr);
    return r
}
...
function Rt(t, e, n, s) {
    ...
    return o => o === 0 || o === 1 ? o : Es(i(o), e, s)
}
const Rs = t => e => e <= .5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2,
    Ls = t => e => 1 - t(1 - e),
    ks = Rt(.33, 1.53, .69, .99),
    Ne = Ls(ks),
    Fs = Rs(Ne),
    Bs = t => (t *= 2) < 1 ? .5 * Ne(t) : .5 * (2 - Math.pow(2, -10 * (t - 1))),
    ...
    hr = Rt(0, 0, .58, 1),
    Os = Rt(.42, 0, .58, 1),
    fr = t => Array.isArray(t) && typeof t[0] != "number",
...
const Ke = ["animate", "whileInView", "whileFocus", "whileHover", "whileTap", "whileDrag", "exit"],
    We = ["initial", ...Ke];

function Yt(t) {
    return Xt(t.animate) || We.some(e => Vt(t[e]))
}
...
const Ft = ["setup", "read", "resolveKeyframes", "preUpdate", "update", "preRender", "render", "postRender"];
...
function Gs(t, e) {
    ...
    const i = {
        ...
        v = () => {
            ...
            n = !1, X.useManualTiming || (i.delta = s ? 1e3 / 60 : Math.max(Math.min(g - i.timestamp, vr), 1)), i.timestamp = g, i.isProcessing = !0, a.process(i), l.process(i), c.process(i), u.process(i), h.process(i), f.process(i), d.process(i), m.process(i), i.isProcessing = !1, n && e && (s = !1, t(v))
        },
        y = () => {
            n = !0, s = !0, i.isProcessing || t(v)
        };
    return {
        schedule: Ft.reduce((g, A) => {
            const P = r[A];
            return g[A] = (w, E = !1, b = !1) => (n || y(), P.schedule(w, E, b)), g
        }, {}),
        cancel: g => {
            for (let A = 0; A < Ft.length; A++) r[Ft[A]].cancel(g)
        },
        state: i,
        steps: r
    }
...
const {
    ...
    state: k,
    steps: qt
} = Gs(typeof requestAnimationFrame < "u" ? requestAnimationFrame : W, !0);
let jt;
...
const j = {
        now: () => (jt === void 0 && j.set(k.isProcessing || X.useManualTiming ? k.timestamp : performance.now()), jt),
        set: t => {
            jt = t, queueMicrotask(Tr)
        }
    },
    Hs = t => e => typeof e == "string" && e.startsWith(t),
    _s = Hs("--"),
    xr = Hs("var(--"),
    $e = t => xr(t) ? Pr.test(t.split("/*")[0].trim()) : !1,
...
const br = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu,
    He = (t, e) => n => !!(typeof n == "string" && br.test(n) && n.startsWith(t) || e && !Sr(n) && Object.prototype.hasOwnProperty.call(n, e)),
    zs = (t, e, n) => s => {
    ...
    nt = {
        ...
        transform: ({
            ...
            blue: n,
            alpha: s = 1
        }) => "rgba(" + Zt.transform(t) + ", " + Zt.transform(e) + ", " + Zt.transform(n) + ", " + Pt(Ct.transform(s)) + ")"
    };
...
const fe = {
    ...
    lt = {
        ...
        transform: ({
            ...
            lightness: n,
            alpha: s = 1
        }) => "hsla(" + Math.round(t) + ", " + _.transform(Pt(e)) + ", " + _.transform(Pt(n)) + ", " + Pt(Ct.transform(s)) + ")"
    },
    D = {
        test: t => nt.test(t) || fe.test(t) || lt.test(t),
        parse: t => nt.test(t) ? nt.parse(t) : lt.test(t) ? lt.parse(t) : fe.parse(t),
...
function Dr(t) {
    return isNaN(t) && typeof t == "string" && (t.match(Ge) ? .length || 0) + (t.match(Mr) ? .length || 0) > 0
}
const Xs = "number",
    Ys = "color",
    Er = "var",
    Rr = "var(",
    vn = "${}",
    Lr = /var\s*\(\s*--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)|#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\)|-?(?:\d+(?:\.\d+)?|\.\d+)/giu;
...
function Mt(t) {
    const e = t.toString(),
        ...
        i = [];
    let o = 0;
    const a = e.replace(Lr, l => (D.test(l) ? (s.color.push(o), i.push(Ys), n.push(D.parse(l))) : l.startsWith(Rr) ? (s.var.push(o), i.push(Er), n.push(l)) : (s.number.push(o), i.push(Xs), n.push(parseFloat(l))), ++o, vn)).split(vn);
    return {
        values: n,
        split: a,
        indexes: s,
...
function Zs(t) {
    ...
    return i => {
        ...
        for (let r = 0; r < s; r++)
            if (o += e[r], i[r] !== void 0) {
                const a = n[r];
                a === Xs ? o += Pt(i[r]) : a === Ys ? o += D.transform(i[r]) : o += i[r]
            }
        return o
    }
}
const kr = t => typeof t == "number" ? 0 : D.test(t) ? D.getAnimatableNone(t) : t;

function Fr(t) {
    const e = qs(t);
    return Zs(t)(e.map(kr))
}
const Z = {
    test: Dr,
    parse: qs,
...
function Br({
    ...
    if (!e) i = o = r = n;
        ...
        const a = n < .5 ? n * (1 + e) : n + e - n * e,
            l = 2 * n - a;
        i = Jt(l, a, t + 1 / 3), o = Jt(l, a, t), r = Jt(l, a, t - 1 / 3)
    }
    return {
...
const C = (t, e, n) => t + (e - t) * n,
    ...
    Ir = [fe, nt, lt],
    jr = t => Ir.find(e => e.test(t));

function Tn(t) {
    const e = jr(t);
    if (!e) return !1;
    let n = e.parse(t);
    return e === lt && (n = Br(n)), n
}
const xn = (t, e) => {
        const n = Tn(t),
            s = Tn(e);
        ...
        return o => (i.red = Qt(n.red, s.red, o), i.green = Qt(n.green, s.green, o), i.blue = Qt(n.blue, s.blue, o), i.alpha = C(n.alpha, s.alpha, o), nt.transform(i))
    },
...
function _e(t) {
    return typeof t == "number" ? Nr : typeof t == "string" ? $e(t) ? Kt : D.test(t) ? xn : Wr : Array.isArray(t) ? Js : typeof t == "object" ? D.test(t) ? xn : Ur : Kt
}
...
const Wr = (t, e) => {
    const n = Z.createTransformer(e),
        s = Mt(t),
        i = Mt(e);
    return s.indexes.var.length === i.indexes.var.length && s.indexes.color.length === i.indexes.color.length && s.indexes.number.length >= i.indexes.number.length ? de.has(t) && !i.values.length || de.has(e) && !s.values.length ? Or(t, e) : Et(Js(Kr(s, i), i.values), n) : Kt(t, e)
};
...
function ze(t) {
    ...
    const n = 50;
    let s = t.next(e);
    for (; !s.done && e < Wt;) e += n, s = t.next(e);
    return e >= Wt ? 1 / 0 : e
}

function Gr(t, e = 100, n) {
    const s = n({ ...t,
            keyframes: [0, e]
        }),
        i = Math.min(ze(s), Wt);
...
function _r({
    ...
    let i, o, r = 1 - e;
    r = z(M.minDamping, M.maxDamping, r), t = z(M.minDuration, M.maxDuration, K(t)), r < 1 ? (i = c => {
        const u = c * r,
            h = u * t,
            f = u - n,
            d = me(c, r),
    ...
    if (!Pn(t, qr) && Pn(t, Yr))
        if (t.visualDuration) {
            const n = t.visualDuration,
                s = 2 * Math.PI / (n * 1.2),
                i = s * s,
                o = 2 * z(.05, 1, 1 - (t.bounce || 0)) * Math.sqrt(i);
            e = { ...e,
                mass: M.mass,
                stiffness: i,
                damping: o
...
function $t(t = M.visualDuration, e = M.bounce) {
    ...
    const A = {
        ...
        next: P => {
            ...
            if (d) a.done = P >= h;
                ...
                let E = P === 0 ? m : 0;
                v < 1 && (E = P === 0 ? H(m) : ei(g, P, w));
                const b = Math.abs(E) <= s,
                    I = Math.abs(r - w) <= i;
                a.done = b && I
            }
        ...
        toString: () => {
            const P = Math.min(ze(A), Wt),
                w = ti(E => A.next(P * E).value, P, 30);
            return P + "ms " + w
        },
        toTransition: () => {}
    };
...
$t.applyToOptions = t => {
    const e = Gr(t, 100, $t);
    return t.ease = e.ease, t.duration = H(e.duration), t.type = "keyframes", t
};
...
function pe({
    ...
    return E(0), {
        ...
        next: b => {
            let I = !1;
            return !w && P === void 0 && (I = !0, A(b), E(b)), P !== void 0 && b >= P ? w.next(b - P) : (!I && A(b), f)
        }
    }
}
...
function Qr(t, e, {
    ...
    const o = t.length;
    if (Ie(o === e.length), o === 1) return () => e[0];
...
function St({
    ...
    const i = fr(s) ? s.map(pn) : pn(s),
        o = {
            done: !1,
            value: e[0]
        },
        r = no(n && n.length === e.length ? n : eo(e), t),
        a = Qr(r, e, {
...
function ni(t) {
    typeof t.type == "string" && (t.type = ro[t.type])
}
class Ye {
    constructor() {
        this.updateFinished()
...
class qe extends Ye {
    ...
    initAnimation() {
        ...
        const l = n || St;
        l !== St && typeof a[0] != "number" && (this.mixKeyframes = Et(oo, Qs(a[0], a[1])), a = [0, 100]);
        const c = l({ ...e,
            keyframes: a
        });
        o === "mirror" && (this.mirroredGenerator = l({ ...e,
            keyframes: [...a].reverse(),
            velocity: -r
        })), c.calculatedDuration === null && (c.calculatedDuration = ze(c));
        const {
    ...
    tick(e, n = !1) {
        ...
        if (h) {
            ...
            let I = Math.floor(b),
                O = b % 1;
            !O && b >= 1 && (O = 1), O === 1 && I--, I = Math.min(I, h + 1), !!(I % 2) && (f === "reverse" ? (O = 1 - O, d && (O -= d / a)) : f === "mirror" && (A = r)), g = z(0, 1, O) * a
        }
        const P = T ? {
            done: !1,
            value: u[0]
        ...
        return E && m !== pe && (P.value = Xe(u, this.options, y, this.speed)), v && v(P.value), E && this.finish(), P
    }
    then(e, n) {
        return this.finished.then(e, n)
    }
    ...
    set time(e) {
        e = H(e), this.currentTime = e, this.startTime === null || this.holdTime !== null || this.playbackSpeed === 0 ? this.holdTime = e : this.driver && (this.startTime = this.driver.now() - e / this.playbackSpeed), this.driver ? .start(!1)
    }
    get speed() {
...
const st = t => t * 180 / Math.PI,
    ...
    ye = t => (t = t % 360, t < 0 && (t += 360), t),
    Sn = ge,
    bn = t => Math.sqrt(t[0] * t[0] + t[1] * t[1]),
    An = t => Math.sqrt(t[4] * t[4] + t[5] * t[5]),
    uo = {
        x: 12,
        y: 13,
        z: 14,
        ...
        scaleY: An,
        scale: t => (bn(t) + An(t)) / 2,
        rotateX: t => ye(st(Math.atan2(t[6], t[5]))),
        rotateY: t => ye(st(Math.atan2(-t[2], t[0]))),
        rotateZ: Sn,
        rotate: Sn,
...
function si() {
    ...
    Pe = !1, xe = !1, rt.forEach(t => t.complete(Se)), rt.clear()
}
...
class Ze {
    ...
    scheduleResolve() {
        this.state = "scheduled", this.isAsync ? (rt.add(this), xe || (xe = !0, V.read(ii), V.resolveKeyframes(si))) : (this.readKeyframes(), this.complete())
    }
    readKeyframes() {
        const {
...
const yo = t => t.startsWith("--");

function vo(t, e, n) {
    yo(e) ? t.style.setProperty(e, n) : t.style[e] = n
}
const To = je(() => window.ScrollTimeline !== void 0),
    xo = {};
...
const ri = Po(() => {
    ...
    xt = ([t, e, n, s]) => `cubic-bezier(${t}, ${e}, ${n}, ${s})`,
    Vn = {
        linear: "linear",
        ease: "ease",
        easeIn: "ease-in",
...
function oi(t, e) {
    if (t) return typeof t == "function" ? ri() ? ti(t, e) : "ease-out" : Ns(t) ? xt(t) : Array.isArray(t) ? t.map(n => oi(n, e) || Vn.easeOut) : Vn[t]
}
...
function bo({
    ...
    return ai(t) && ri() ? t.applyToOptions(e) : (e.duration ? ? (e.duration = 300), e.ease ? ? (e.ease = "easeOut"), e)
}
class Ao extends Ye {
    constructor(e) {
        ...
        this.isPseudoElement = !!o, this.allowFlatten = r, this.options = e, Ie(typeof e.type != "string");
        const c = bo(e);
        this.animation = So(n, s, i, c, o), c.autoplay === !1 && this.animation.pause(), this.animation.onfinish = () => {
            if (this.finishedTime = this.time, !o) {
                const u = Xe(i, this.options, a, this.speed);
                this.updateMotionValue ? this.updateMotionValue(u) : vo(n, s, u), this.animation.cancel()
            }
    ...
    attachTimeline({
        ...
        return this.allowFlatten && this.animation.effect ? .updateTiming({
            easing: "linear"
        }), this.animation.onfinish = null, e && To() ? (this.animation.timeline = e, W) : n(this)
    }
}
const li = {
    anticipate: Bs,
...
function Vo(t) {
    typeof t.ease == "string" && wo(t.ease) && (t.ease = li[t.ease])
}
const Cn = 10;
class Co extends Ao {
    constructor(e) {
        Vo(e), ni(e), super(e), e.startTime && (this.startTime = e.startTime), this.options = e
    }
    updateMotionValue(e) {
        const {
            motionValue: n,
        ...
        const a = new qe({ ...r,
            ...
            l = H(this.finishedTime ? ? this.time);
        n.setWithVelocity(a.sample(l - Cn).value, a.sample(l).value, Cn), a.stop()
    }
}
const Mn = (t, e) => e === "zIndex" ? !1 : !!(typeof t == "number" || Array.isArray(t) || typeof t == "string" && (Z.test(t) || t === "0") && !t.startsWith("url("));
...
function Do(t, e, n, s) {
    ...
    const o = t[t.length - 1],
        r = Mn(i, e),
        a = Mn(o, e);
    return !r || !a ? !1 : Mo(t) || (n === "spring" || ai(n)) && s
}
...
const Eo = new Set(["opacity", "clipPath", "filter", "transform"]),
    Ro = je(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
...
function Lo(t) {
    ...
    return Ro() && n && Eo.has(n) && (n !== "transform" || !c) && !l && !s && i !== "mirror" && o !== 0 && r !== "inertia"
}
const ko = 40;
class Fo extends Ye {
    constructor({
    ...
    onKeyframesResolved(e, n, s, i) {
        ...
        this.resolvedAt = j.now(), Do(e, o, r, a) || ((X.instantAnimations || !l) && u ? .(Xe(e, s, n)), e[0] = e[e.length - 1], be(s), s.repeat = 0);
        const f = {
                startTime: i ? this.resolvedAt ? this.resolvedAt - this.createdAt > ko ? this.resolvedAt : this.createdAt : this.createdAt : void 0,
                finalKeyframe: n,
                ...s,
                keyframes: e
            },
    ...
    get animation() {
        return this._animation || (this.keyframeResolver ? .resume(), go()), this._animation
    }
    get duration() {
...
function ui(t, e, n = 1) {
    ...
    if (o) {
        const r = o.trim();
        return Vs(r) ? parseFloat(r) : r
    }
    return $e(i) ? ui(i, e, n + 1) : i
}

function Je(t, e) {
    return t ? .[e] ? ? t ? .default ? ? t
}
const ci = new Set(["width", "height", "top", "left", "right", "bottom", ...yt]),
    jo = {
        test: t => t === "auto",
        parse: t => t
    },
    hi = t => e => e.test(t),
    fi = [gt, x, _, Y, Cr, Vr, jo],
    Dn = t => fi.find(hi(t));

function Oo(t) {
    return typeof t == "number" ? t === 0 : t !== null ? t === "none" || t === "0" || Ms(t) : !0
}
const No = new Set(["brightness", "contrast", "saturate", "opacity"]);
...
function mi(t, e) {
    let n = di(t);
    return n !== Ae && (n = Z), n.getAnimatableNone ? n.getAnimatableNone(e) : void 0
}
...
function Ho(t, e, n) {
    ...
    for (; s < t.length && !i;) {
        const o = t[s];
        typeof o == "string" && !Go.has(o) && Mt(o).values.length && (i = t[s]), s++
    }
    if (i && n)
        for (const o of e) t[o] = mi(n, i)
}
class _o extends Ze {
    ...
    readKeyframes() {
        ...
        for (let l = 0; l < e.length; l++) {
            ...
            if (typeof c == "string" && (c = c.trim(), $e(c))) {
                const u = ui(c, n.current);
                u !== void 0 && (e[l] = u), l === e.length - 1 && (this.finalKeyframe = c)
            }
        }
        if (this.resolveNoneKeyframes(), !ci.has(s) || e.length !== 2) return;
    ...
    resolveNoneKeyframes() {
        ...
        for (let i = 0; i < e.length; i++)(e[i] === null || Oo(e[i])) && s.push(i);
        s.length && Ho(e, s, n)
    }
    measureInitialState() {
        const {
...
const pi = (t, e) => e && typeof t == "number" ? e.transform(t) : t;

function Xo(t) {
    return Cs(t) && "offsetHeight" in t
}
const Rn = 30,
    Yo = t => !isNaN(parseFloat(t));
class qo {
    constructor(e, n = {}) {
    ...
    setCurrent(e) {
        this.current = e, this.updatedAt = j.now(), this.canTrackVelocity === null && e !== void 0 && (this.canTrackVelocity = Yo(this.current))
    }
    ...
    getVelocity() {
        const e = j.now();
        if (!this.canTrackVelocity || this.prevFrameValue === void 0 || e - this.updatedAt > Rn) return 0;
        const n = Math.min(this.updatedAt - this.prevUpdatedAt, Rn);
...
function Jo(t, e, n = {}) {
    const [s, i, o] = yi(t, n), r = a => {
        ...
        const u = h => {
            Ln(h) && (c(h), l.removeEventListener("pointerleave", u))
        };
...
const vi = (t, e) => e ? t === e ? !0 : vi(t, e.parentElement) : !1,
    en = t => t.pointerType === "mouse" ? typeof t.button != "number" || t.button <= 0 : t.isPrimary !== !1,
...
function na(t, e, n = {}) {
    const [s, i, o] = yi(t, n), r = a => {
        ...
        const c = e(l, a),
            u = (d, m) => {
                window.removeEventListener("pointerup", h), window.removeEventListener("pointercancel", f), Ot.has(l) && Ot.delete(l), Fn(d) && typeof c == "function" && c(d, {
                    success: m
                })
            },
            h = d => {
    ...
    return s.forEach(a => {
        (n.useGlobalTarget ? window : a).addEventListener("pointerdown", r, i), Xo(a) && (a.addEventListener("focus", c => ea(c, i)), !ta(a) && !a.hasAttribute("tabindex") && (a.tabIndex = 0))
    }), o
}
...
function xi(t, {
    ...
    return vt.has(t) || t.startsWith("origin") || (e || n !== void 0) && (!!we[t] || t === "opacity")
}
const aa = {
        x: "translateX",
        y: "translateY",
...
function nn(t, e, n) {
    ...
    if (e.transform || (r || n ? s.transform = ua(e, t.transform, n) : s.transform && (s.transform = "none")), a) {
        const {
            originX: l = "50%",
            originY: c = "50%",
            originZ: u = 0
...
function ha(t, e) {
    const n = t.style || {},
        s = {};
    return Pi(s, n, t), Object.assign(s, ca(t, e)), s
}
...
function Si(t, {
    ...
    h.transform && (f.transform = h.transform, delete h.transform), (f.transform || h.transformOrigin) && (f.transformOrigin = h.transformOrigin ? ? "50% 50%", delete h.transformOrigin), f.transform && (f.transformBox = u ? .transformBox ? ? "fill-box", delete h.transformBox), e !== void 0 && (h.x = e), n !== void 0 && (h.y = n), s !== void 0 && (h.scale = s), i !== void 0 && pa(h, i, o, r, !1)
}
const bi = () => ({ ...sn(),
        attrs: {}
    }),
...
function ga(t, e, n, s) {
    const i = S.useMemo(() => {
        const o = bi();
        return Si(o, e, Ai(s), t.transformTemplate, t.style), { ...o.attrs,
            style: { ...o.style
            }
        }
    }, [e]);
    if (t.style) {
        const o = {};
        Pi(o, t.style, t), i.style = { ...o,
            ...i.style
        }
    }
    return i
}
const ya = new Set(["animate", "exit", "variants", "initial", "style", "values", "variants", "transition", "transformTemplate", "custom", "inherit", "onBeforeLayoutMeasure", "onAnimationStart", "onAnimationComplete", "onUpdate", "onDragStart", "onDrag", "onDragEnd", "onMeasureDragConstraints", "onDirectionLock", "onDragTransitionEnd", "_dragX", "_dragY", "onHoverStart", "onHoverEnd", "onViewportEnter", "onViewportLeave", "globalTapTarget", "ignoreStrict", "viewport"]);
...
function va(t) {
    typeof t == "function" && (wi = e => e.startsWith("on") ? !Gt(e) : t(e))
}
try {
...
function Ta(t, e, n) {
    const s = {};
    for (const i in t) i === "values" && typeof t.values == "object" || (wi(i) || n === !0 && Gt(i) || !e && !Gt(i) || t.draggable && i.startsWith("onDrag")) && (s[i] = t[i]);
    return s
}
const xa = ["animate", "circle", "defs", "desc", "ellipse", "g", "image", "line", "filter", "marker", "mask", "metadata", "path", "pattern", "polygon", "polyline", "rect", "stop", "switch", "symbol", "svg", "text", "tspan", "use", "view"];

function rn(t) {
    return typeof t != "string" || t.includes("-") ? !1 : !!(xa.indexOf(t) > -1 || /[A-Z]/u.test(t))
}

function Pa(t, e, n, {
    latestValues: s
}, i, o = !1) {
    const a = (rn(t) ? ga : fa)(e, s, i, t),
        l = Ta(e, typeof t == "string", o),
        c = t !== S.Fragment ? { ...l,
            ...a,
            ref: n
        } : {},
        ...
        h = S.useMemo(() => F(u) ? u.get() : u, [u]);
    return S.createElement(t, { ...c,
        children: h
    })
}
const on = S.createContext(null);
...
function ln(t, e, n) {
    ...
    for (const o in s)(F(s[o]) || e.style && F(e.style[o]) || xi(o, t) || n ? .getValue(o) ? .liveStyle !== void 0) && (i[o] = s[o]);
    return i
}
const wa = Vi({
...
const Ma = Symbol.for("motionComponentSymbol");
...
function Da(t, e, n) {
    return S.useCallback(s => {
        s && t.onMount && t.onMount(s), e && (s ? e.mount(s) : e.unmount()), n && (typeof n == "function" ? n(s) : ut(n) && (n.current = s))
    }, [e])
}
const cn = t => t.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase(),
    ...
    Mi = "data-" + cn(Ea),
    Di = S.createContext({}),
    Ra = un ? S.useLayoutEffect : S.useEffect;

function La(t, e, n, s, i) {
    const {
        visualElement: o
    } = S.useContext(zt), r = S.useContext(Ks), a = S.useContext(on), l = S.useContext(Ws).reducedMotion, c = S.useRef(null);
    ...
    const u = c.current,
        h = S.useContext(Di);
    u && !u.projection && i && (u.type === "html" || u.type === "svg") && ka(c.current, n, i, h);
    const f = S.useRef(!1);
    S.useInsertionEffect(() => {
        u && f.current && u.update(n, a)
    });
    const d = n[Mi],
        m = S.useRef(!!d && !window.MotionHandoffIsComplete ? .(d) && window.MotionHasOptimisedAnimation ? .(d));
    return Ra(() => {
...
function ka(t, e, n, s) {
    ...
    t.projection = new n(t.latestValues, e["data-framer-portal-id"] ? void 0 : Ei(t.parent)), t.projection.setOptions({
        layoutId: i,
        layout: o,
...
function Ei(t) {
    if (t) return t.options.allowProjection !== !1 ? t.projection : Ei(t.parent)
}
...
function ne(t, {
    ...
    function o(a, l) {
        ...
        if (!h && un) {
            Ba();
            const m = Ia(u);
            c = m.MeasureLayout, f.visualElement = La(t, d, u, s, m.ProjectionNode)
        }
        return he.jsxs(zt.Provider, {
            value: f,
            children: [c && f.visualElement ? he.jsx(c, {
                visualElement: f.visualElement,
                ...u
            }) : null, Pa(t, a, Da(d, f.visualElement, l), d, h, e)]
        })
    }
...
function Fa({
    ...
    const e = S.useContext(Us).id;
    return e && t !== void 0 ? e + "-" + t : t
}

function Ba(t, e) {
    S.useContext(Ks).strict
}
...
function et(t) {
    return Ve(t) || Li(t) || t.z || t.rotate || t.rotateX || t.rotateY || t.skewX || t.skewY
}
...
function Na(t, e, n, s = !1) {
    ...
    for (let a = 0; a < i; a++) {
        ...
        l && l.props.style && l.props.style.display === "contents" || (s && o.options.layoutScroll && o.scroll && o !== o.root && ht(t, {
            x: -o.scroll.offset.x,
            y: -o.scroll.offset.y
        }), r && (e.x *= r.x.scale, e.y *= r.y.scale, ki(t, r)), s && et(o.latestValues) && ht(t, o.latestValues))
    }
...
function Fi(t, e) {
    return Ri(Oa(t.getBoundingClientRect(), e))
}
...
class Ga {
    ...
    constructor({
        ...
        } : {}, this.renderState = c, this.parent = e, this.props = n, this.presenceContext = s, this.depth = e ? e.depth + 1 : 0, this.reducedMotionConfig = i, this.options = a, this.blockInitialAnimation = !!o, this.isControllingVariants = Yt(n), this.isVariantNode = $s(n), this.isVariantNode && (this.variantChildren = new Set), this.manuallyAnimateOnMount = !!(e && e.current);
        const {
            willChange: u,
            ...h
    ...
    mount(e) {
        this.current = e, Wa.set(e, this), this.projection && !this.projection.instance && this.projection.mount(e), this.parent && this.isVariantNode && !this.isControllingVariants && (this.removeFromVariantTree = this.parent.addVariantChild(this)), this.values.forEach((n, s) => this.bindToMotionValue(s, n)), Bi.current || Ka(), this.shouldReduceMotion = this.reducedMotionConfig === "never" ? !1 : this.reducedMotionConfig === "always" ? !0 : Me.current, this.parent ? .addChild(this), this.update(this.props, this.presenceContext)
    }
    unmount() {
    ...
    update(e, n) {
        ...
        this.prevMotionValues = $a(this, this.scrapeMotionValuesFromProps(e, this.prevProps, this), this.prevMotionValues), this.handleChildMotionValue && this.handleChildMotionValue()
    }
    getProps() {
        return this.props
    }
    ...
    getValue(e, n) {
        ...
        return s === void 0 && n !== void 0 && (s = mt(n === null ? void 0 : n, {
            owner: this
        }), this.addValue(e, s)), s
    }
    readValue(e, n) {
        let s = this.latestValues[e] !== void 0 || !this.current ? this.latestValues[e] : this.getBaseTargetFromProps(this.props, e) ? ? this.readValueFromInstance(this.current, e, this.options);
        return s != null && (typeof s == "string" && (Vs(s) || Ms(s)) ? s = parseFloat(s) : !ra(s) && Z.test(n) && (s = mi(e, n)), this.setBaseTarget(e, F(s) ? s.get() : s)), F(s) ? s.get() : s
    }
    setBaseTarget(e, n) {
        this.baseTarget[e] = n
    }
...
class _a extends Ii {
    ...
    readValueFromInstance(e, n) {
        if (vt.has(n)) return this.projection ? .isProjecting ? ve(n) : co(e, n); {
            const s = Ha(e),
                i = (_s(n) ? s.getPropertyValue(n) : s[n]) || 0;
...
const Oi = new Set(["baseFrequency", "diffuseConstant", "kernelMatrix", "kernelUnitLength", "keySplines", "keyTimes", "limitingConeAngle", "markerHeight", "markerWidth", "numOctaves", "targetX", "targetY", "surfaceScale", "specularConstant", "specularExponent", "stdDeviation", "tableValues", "viewBox", "gradientTransform", "pathLength", "startOffset", "textLength", "lengthAdjust"]);

function za(t, e, n, s) {
    ji(t, e, void 0, s);
    for (const i in e.attrs) t.setAttribute(Oi.has(i) ? i : cn(i), e.attrs[i])
}
class Xa extends Ii {
    constructor() {
    ...
    readValueFromInstance(e, n) {
        ...
        return n = Oi.has(n) ? n : cn(n), e.getAttribute(n)
    }
    scrapeMotionValuesFromProps(e, n, s) {
        return Ci(e, n, s)
    }
    build(e, n, s) {
        Si(e, n, this.isSVGTag, s.transformTemplate, s.style)
    }
...
const Ya = (t, e) => rn(t) ? new Xa(e) : new _a(e, {
...
const nl = {
    ...
    ol = (t, {
        keyframes: e
    }) => e.length > 2 ? il : vt.has(t) ? t.startsWith("scale") ? sl(e[1]) : nl : rl;
...
const hn = (t, e, n, s = {}, i, o) => r => {
    ...
    al(a) || Object.assign(u, ol(t, u)), u.duration && (u.duration = H(u.duration)), u.repeatDelay && (u.repeatDelay = H(u.repeatDelay)), u.from !== void 0 && (u.keyframes[0] = u.from);
    let h = !1;
    if ((u.type === !1 || u.duration === 0 && !u.repeatDelay) && (be(u), u.delay === 0 && (h = !0)), (X.instantAnimations || X.skipAnimations) && (h = !0, be(u), u.delay = 0), u.allowFlatten = !a.type && !a.ease, h && !o && e.get() !== void 0) {
        const f = el(u.keyframes, a);
        if (f !== void 0) {
            V.update(() => {
    ...
    return a.isSync ? new qe(u) : new Fo(u)
};
...
function Ui(t, e, {
    ...
    for (const u in a) {
        ...
        Ee(t, u), h.start(hn(u, h, f, t.shouldReduceMotion && ci.has(u) ? {
            type: !1
        } : d, t, v));
        const y = h.animation;
        y && l.push(y)
...
function Re(t, e, n = {}) {
    const s = dt(t, e, n.type === "exit" ? t.presenceContext ? .custom : void 0);
    let {
        transition: i = t.getDefaultTransition() || {}
    } = s || {};
    n.transitionOverride && (i = n.transitionOverride);
    const o = s ? () => Promise.all(Ui(t, s, n)) : () => Promise.resolve(),
...
function ul(t, e, n = 0, s = 0, i = 0, o = 1, r) {
    const a = [];
    for (const l of t.variantChildren) l.notify("AnimationStart", e), a.push(Re(l, e, { ...r,
        delay: n + (typeof s == "function" ? 0 : s) + Ki(t.variantChildren, l, s, i, o)
...
function pl(t) {
    let e = ml(t),
        ...
        s = !0;
    const i = l => (c, u) => {
        const h = dt(t, u, l === "exit" ? t.presenceContext ? .custom : void 0);
        if (h) {
            const {
                transition: f,
                transitionEnd: d,
    ...
    function r(l) {
        ...
        for (let y = 0; y < dl; y++) {
            ...
            if (w && s && t.manuallyAnimateOnMount && (w = !1), T.protectedKeys = { ...d
                }, !T.isActive && P === null || !g && !T.prevProp || Xt(g) || typeof g == "boolean") continue;
            const E = gl(T.prevProp, g);
            let b = E || p === l && T.isActive && !w && A || y > m && A,
                I = !1;
            ...
            for (const L in ir) {
                ...
                let at = !1;
                De(N) && De(Q) ? at = !Wi(N, Q) : at = N !== Q, at ? N != null ? dn(L) : f.add(L) : N !== void 0 && f.has(L) ? dn(L) : T.protectedKeys[L] = !0
            }
            T.prevProp = g, T.prevResolvedValues = ot, T.isActive && (d = { ...d,
                ...ot
            }), s && t.blockInitialAnimation && (b = !1);
            const mn = w && E;
            b && (!mn || I) && h.push(...O.map(L => {
                const N = {
                    type: p
                };
                if (typeof L == "string" && s && !mn && t.manuallyAnimateOnMount && t.parent) {
                    ...
                    if (Q.enteringChildren && at) {
                        const {
                            delayChildren: rr
                        } = at.transition || {};
                        N.delay = Ki(Q.enteringChildren, t, rr)
                    }
                }
                return {
                    animation: L,
        ...
        if (f.size) {
            ...
            if (typeof c.initial != "boolean") {
                const p = dt(t, Array.isArray(c.initial) ? c.initial[0] : c.initial);
...
class yl extends J {
    constructor(e) {
        super(e), e.animationState || (e.animationState = pl(e))
    }
...
const Pl = t => e => en(e) && t(e, kt(e));

function bt(t, e, n, s) {
    return Dt(t, e, Pl(n), s)
}
const Gi = 1e-4,
    Sl = 1 - Gi,
    bl = 1 + Gi,
...
function zn(t, e, n, s = .5) {
    t.origin = s, t.originPoint = C(e.min, e.max, t.origin), t.scale = B(n) / B(e), t.translate = C(n.min, n.max, t.origin) - t.originPoint, (t.scale >= Sl && t.scale <= bl || isNaN(t.scale)) && (t.scale = 1), (t.translate >= Al && t.translate <= wl || isNaN(t.translate)) && (t.translate = 0)
}
...
class zi {
    constructor(e, n, {
        ...
        if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.handlers = {}, this.contextWindow = window, this.updatePoint = () => {
                ...
                const f = re(this.lastMoveEventInfo, this.history),
                ...
                this.lastMoveEvent = f, this.lastMoveEventInfo = ie(d, this.transformPagePoint), V.update(this.updatePoint, !0)
                ...
                const p = re(f.type === "pointercancel" ? this.lastMoveEventInfo : ie(d, this.transformPagePoint), this.history);
        ...
        const a = kt(e),
            l = ie(a, this.transformPagePoint),
            {
                point: c
            } = l,
            {
        ...
        h && h(e, re(l, this.history)), this.removeListeners = Et(bt(this.contextWindow, "pointermove", this.handlePointerMove), bt(this.contextWindow, "pointerup", this.handlePointerUp), bt(this.contextWindow, "pointercancel", this.handlePointerUp))
    }
    updateHandlers(e) {
        this.handlers = e
    }
...
function Fl(t, e) {
    ...
    const s = B(t),
        i = B(e);
    return i > s ? n = wt(e.min, e.max - s, t.min) : s > i && (n = wt(t.min, t.max - i, e.min)), z(0, 1, n)
}
...
class Ol {
    ...
    start(e, {
        ...
        const o = h => {
                ...
                f ? this.pauseAnimation() : this.stopAnimation(), n && this.snapToCursor(kt(h).point)
            },
            r = (h, f) => {
                const {
                    drag: d,
                ...
                if (d && !m && (this.openDragLock && this.openDragLock(), this.openDragLock = Zo(d), !this.openDragLock)) return;
                this.latestPointerEvent = h, this.latestPanInfo = f, this.isDragging = !0, this.currentDirection = null, this.resolveConstraints(), this.visualElement.projection && (this.visualElement.projection.isAnimationBlocked = !0, this.visualElement.projection.target = void 0), U(p => {
                    ...
                    if (_.test(T)) {
                        ...
                        if (g && g.layout) {
                            const A = g.layout.layoutBox[p];
                            A && (T = B(A) * (parseFloat(T) / 100))
                        }
                    }
                    this.originPoint[p] = T
                }), v && V.postRender(() => v(h, f)), Ee(this.visualElement, "transform");
                const {
                    animationState: y
                } = this.visualElement;
            ...
            a = (h, f) => {
                ...
                if (m && this.currentDirection === null) {
                    this.currentDirection = Nl(p), this.currentDirection !== null && v && v(this.currentDirection);
                    return
                }
    ...
    resolveConstraints() {
        ...
        e && ut(e) ? this.constraints || (this.constraints = this.resolveRefConstraints()) : e && s ? this.constraints = Ll(s.layoutBox, e) : this.constraints = !1, this.elastic = Il(n), i !== this.constraints && s && this.constraints && !this.hasMutatedConstraints && U(o => {
            this.constraints !== !1 && this.getAxisMotionValue(o) && (this.constraints[o] = Bl(s.layoutBox[o], this.constraints[o]))
        })
    }
    resolveRefConstraints() {
        ...
        const o = Ua(s, i.root, this.visualElement.getTransformPagePoint());
        let r = kl(i.layout.layoutBox, o);
        if (n) {
            const a = n(ja(r));
            this.hasMutatedConstraints = !!a, a && (r = Ri(a))
        }
        return r
    }
    startAnimation(e) {
    ...
    startAxisValueAnimation(e, n) {
        ...
        return Ee(this.visualElement, e), s.start(hn(e, s, 0, n, this.visualElement, !1))
    }
    stopAnimation() {
    ...
    addListeners() {
        ...
        const e = this.visualElement.current,
            ...
            s = () => {
                ...
                ut(l) && l.current && (this.constraints = this.resolveRefConstraints())
            },
            {
                projection: i
            } = this.visualElement,
        ...
        const r = Dt(window, "resize", () => this.scalePositionWithinConstraints()),
...
class Ul extends J {
    constructor(e) {
        super(e), this.removeGroupControls = W, this.removeListeners = W, this.controls = new Ol(e)
    }
    mount() {
        const {
            dragControls: e
...
class $l extends S.Component {
    componentDidMount() {
        ...
        o && (n.group && n.group.add(o), s && s.register && i && s.register(o), oe && o.root.didUpdate(), o.addEventListener("animationComplete", () => {
            this.safeToRemove()
    ...
    getSnapshotBeforeUpdate(e) {
        ...
        return r && (r.isPresent = o, oe = !0, i || e.layoutDependency !== n || n === void 0 || e.isPresent !== o ? r.willUpdate() : this.safeToRemove(), e.isPresent !== o && (o ? r.promote() : r.relegate() || V.postRender(() => {
            const a = r.getStack();
    ...
    componentWillUnmount() {
        ...
        oe = !0, i && (i.scheduleCheckAfterUnmount(), n && n.group && n.group.remove(i), s && s.deregister && s.deregister(i))
    }
    safeToRemove() {
        const {
            safeToRemove: e
...
function Yi(t) {
    const [e, n] = Wl(), s = S.useContext(Us);
    return he.jsx($l, { ...t,
        layoutGroup: s,
        switchLayoutGroup: S.useContext(Di),
        isPresent: e,
        safeToRemove: n
    })
}
...
class _l {
    ...
    remove(e) {
        Be(this.children, e), this.isDirty = !0
    }
    forEach(e) {
...
const qi = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"],
    ...
    is = t => typeof t == "number" || x.test(t);

function Yl(t, e, n, s, i, o) {
    i ? (t.opacity = C(0, n.opacity ? ? 1, ql(s)), t.opacityExit = C(e.opacity ? ? 1, 0, Zl(s))) : o && (t.opacity = C(e.opacity ? ? 1, n.opacity ? ? 1, s));
    for (let r = 0; r < Xl; r++) {
        const a = `border${qi[r]}Radius`;
        let l = rs(e, a),
            c = rs(n, a);
        if (l === void 0 && c === void 0) continue;
        l || (l = 0), c || (c = 0), l === 0 || c === 0 || is(l) === is(c) ? (t[a] = Math.max(C(ss(l), ss(c), s), 0), (_.test(c) || _.test(l)) && (t[a] += "%")) : t[a] = c
...
function Jl(t, e = 0, n = 1, s = .5, i, o = t, r = t) {
    if (_.test(e) && (e = parseFloat(e), e = C(r.min, r.max, e / 100) - r.min), typeof e != "number") return;
...
const Ql = ["x", "scaleX", "originX"],
    tu = ["y", "scaleY", "originY"];

function cs(t, e, n, s) {
    us(t.x, e, Ql, n ? n.x : void 0, s ? s.x : void 0), us(t.y, e, tu, n ? n.y : void 0, s ? s.y : void 0)
}
...
class nu {
    ...
    add(e) {
        Fe(this.members, e), e.scheduleRender()
    }
    remove(e) {
        if (Be(this.members, e), e === this.prevLead && (this.prevLead = void 0), e === this.lead) {
...
function tr(t) {
    ...
    s && !s.hasCheckedOptimisedAppear && tr(s)
}
    ...
    return class {
        constructor(r = {}, a = e ? .()) {
            this.id = ru++, this.animationId = 0, this.animationCommitId = 0, this.children = new Set, this.options = {}, this.isTreeAnimating = !1, this.isAnimationBlocked = !1, this.isLayoutDirty = !1, this.isProjectionDirty = !1, this.isSharedProjectionDirty = !1, this.isTransformDirty = !1, this.updateManuallyBlocked = !1, this.updateBlockedByResize = !1, this.isUpdating = !1, this.isSVG = !1, this.needsReset = !1, this.shouldResetTransform = !1, this.hasCheckedOptimisedAppear = !1, this.treeScale = {
                ...
                this.projectionUpdateScheduled = !1, this.nodes.forEach(lu), this.nodes.forEach(fu), this.nodes.forEach(du), this.nodes.forEach(uu)
        ...
        addEventListener(r, a) {
            return this.eventHandlers.has(r) || this.eventHandlers.set(r, new Oe), this.eventHandlers.get(r).add(a)
        }
        notifyListeners(r, ...a) {
        ...
        mount(r) {
            ...
            this.isSVG = Ti(r) && !sa(r), this.instance = r;
            const {
                layoutId: a,
                layout: l,
                visualElement: c
            ...
            if (c && !c.current && c.mount(r), this.root.nodes.add(this), this.parent && this.parent.children.add(this), this.root.hasTreeAnimated && (l || a) && (this.isLayoutDirty = !0), t) {
                ...
                V.read(() => {
                    ...
                    d !== h && (h = d, this.root.updateBlockedByResize = !0, u && u(), u = zl(f, 250), Ut.hasAnimatedSinceResize && (Ut.hasAnimatedSinceResize = !1, this.nodes.forEach(vs)))
                })
            }
            a && this.root.registerSharedNode(a, this), this.options.animate !== !1 && c && (a || l) && this.addEventListener("didUpdate", ({
                ...
                const m = this.options.transition || c.getDefaultTransition() || vu,
                    ...
                    p = !this.targetLayout || !Qi(this.targetLayout, d),
                    T = !h && f;
                ...
                } else h || vs(this), this.isLead() && this.options.onExitComplete && this.options.onExitComplete();
                this.targetLayout = d
            })
        }
        unmount() {
        ...
        willUpdate(r = !0) {
            ...
            if (window.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && tr(this), !this.root.isUpdating && this.root.startUpdate(), this.isLayoutDirty) return;
        ...
        update() {
            ...
            this.animationCommitId = this.animationId, this.isUpdating ? (this.isUpdating = !1, this.nodes.forEach(hu), this.nodes.forEach(ou), this.nodes.forEach(au)) : this.nodes.forEach(ys), this.clearAllSnapshots();
            const a = j.now();
            k.delta = z(0, 1e3 / 60, a - k.timestamp), k.timestamp = a, k.isProcessing = !0, qt.update.process(k), qt.preRender.process(k), qt.render.process(k), k.isProcessing = !1
        }
        didUpdate() {
            this.updateScheduled || (this.updateScheduled = !0, tn.read(this.scheduleUpdate))
        }
        clearAllSnapshots() {
            this.nodes.forEach(cu), this.sharedNodes.forEach(pu)
        }
        ...
        resetTransform() {
            ...
            const r = this.isLayoutDirty || this.shouldResetTransform || this.options.alwaysMeasureLayout,
                a = this.projectionDelta && !Ji(this.projectionDelta),
        ...
        measurePageBox() {
            ...
            if (!(this.scroll ? .wasRoot || this.path.some(xu))) {
                const {
                    scroll: c
                } = this.root;
                c && (ct(a.x, c.offset.x), ct(a.y, c.offset.y))
            }
            return a
        }
        removeElementScroll(r) {
            const a = R();
            if ($(a, r), this.scroll ? .wasRoot) return a;
            for (let l = 0; l < this.path.length; l++) {
                ...
                c !== this.root && u && h.layoutScroll && (u.wasRoot && $(a, r), ct(a.x, u.offset.x), ct(a.y, u.offset.y))
            }
            return a
        }
        applyTransform(r, a = !1) {
            ...
            for (let c = 0; c < this.path.length; c++) {
                const u = this.path[c];
                !a && u.options.layoutScroll && u.scroll && u !== u.root && ht(l, {
                    x: -u.scroll.offset.x,
                    y: -u.scroll.offset.y
                }), et(u.latestValues) && ht(l, u.latestValues)
            }
        ...
        removeTransform(r) {
            ...
            for (let l = 0; l < this.path.length; l++) {
                const c = this.path[l];
                if (!c.instance || !et(c.latestValues)) continue;
                Ve(c.latestValues) && c.updateSnapshot();
                const u = R(),
                    h = c.measurePageBox();
                $(u, h), cs(a, c.latestValues, c.snapshot ? c.snapshot.layoutBox : void 0, u)
            }
            return et(this.latestValues) && cs(a, this.latestValues), a
        }
        setTargetDelta(r) {
        ...
        resolveTargetDelta(r = !1) {
            ...
            f && this.linkedParentVersion !== f.layoutVersion && !f.options.layoutRoot && this.removeRelativeTarget(), !this.targetDelta && !this.relativeTarget && (f && f.layout ? this.createRelativeTarget(f, this.layout.layoutBox, f.layout.layoutBox) : this.removeRelativeTarget()), !(!this.relativeTarget && !this.targetDelta) && (this.target || (this.target = R(), this.targetWithTransforms = R()), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target ? (this.forceRelativeParentToResolveTarget(), Cl(this.target, this.relativeTarget, this.relativeParent.target)) : this.targetDelta ? (this.resumingFrom ? this.target = this.applyTransform(this.layout.layoutBox) : $(this.target, this.layout.layoutBox), ki(this.target, this.targetDelta)) : $(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget && (this.attemptToResolveRelativeTarget = !1, f && !!f.resumingFrom == !!this.resumingFrom && !f.options.layoutScroll && f.target && this.animationProgress !== 1 ? this.createRelativeTarget(f, this.target, f.target) : this.relativeParent = this.relativeTarget = void 0))
        }
        getClosestProjectingParent() {
            if (!(!this.parent || Ve(this.parent.latestValues) || Li(this.parent.latestValues))) return this.parent.isProjecting() ? this.parent : this.parent.getClosestProjectingParent()
        }
        isProjecting() {
            return !!((this.relativeTarget || this.targetDelta || this.options.layoutRoot) && this.layout)
        }
        createRelativeTarget(r, a, l) {
            this.relativeParent = r, this.linkedParentVersion = r.layoutVersion, this.forceRelativeParentToResolveTarget(), this.relativeTarget = R(), this.relativeTargetOrigin = R(), _t(this.relativeTargetOrigin, a, l), $(this.relativeTarget, this.relativeTargetOrigin)
        }
        ...
        calcProjection() {
            ...
            const h = this.treeScale.x,
                f = this.treeScale.y;
            Na(this.layoutCorrected, this.treeScale, this.path, a), r.layout && !r.target && (this.treeScale.x !== 1 || this.treeScale.y !== 1) && (r.target = r.layout.layoutBox, r.targetWithTransforms = R());
            const {
                target: d
            } = r;
            if (!d) {
                ...
                return
            }!this.projectionDelta || !this.prevProjectionDelta ? this.createProjectionDeltas() : (as(this.prevProjectionDelta.x, this.projectionDelta.x), as(this.prevProjectionDelta.y, this.projectionDelta.y)), At(this.projectionDelta, this.layoutCorrected, d, this.latestValues), (this.treeScale.x !== h || this.treeScale.y !== f || !ps(this.projectionDelta.x, this.prevProjectionDelta.x) || !ps(this.projectionDelta.y, this.prevProjectionDelta.y)) && (this.hasProjected = !0, this.scheduleRender(), this.notifyListeners("projectionUpdate", d))
        }
        hide() {
            this.isVisible = !1
        }
        ...
        setAnimationOrigin(r, a = !1) {
            ...
            const f = R(),
                ...
                T = !!(v && !p && this.options.crossfade === !0 && !this.path.some(yu));
            this.animationProgress = 0;
            let g;
            this.mixTargetDelta = A => {
                const P = A / 1e3;
                Ts(h.x, r.x, P), Ts(h.y, r.y, P), this.setTargetDelta(h), this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout && (_t(f, this.layout.layoutBox, this.relativeParent.layout.layoutBox), gu(this.relativeTarget, this.relativeTargetOrigin, f, P), g && eu(this.relativeTarget, g) && (this.isProjectionDirty = !1), g || (g = R()), $(g, this.relativeTarget)), v && (this.animationValues = u, Yl(u, c, this.latestValues, P, T, p)), this.root.scheduleUpdateProjection(), this.scheduleRender(), this.animationProgress = P
        ...
        startAnimation(r) {
            this.notifyListeners("animationStart"), this.currentAnimation ? .stop(), this.resumingFrom ? .currentAnimation ? .stop(), this.pendingAnimation && (q(this.pendingAnimation), this.pendingAnimation = void 0), this.pendingAnimation = V.update(() => {
                Ut.hasAnimatedSinceResize = !0, this.motionValue || (this.motionValue = mt(0)), this.currentAnimation = Gl(this.motionValue, [0, 1e3], { ...r,
                    velocity: 0,
                    isSync: !0,
                    onUpdate: a => {
        ...
        applyTransformsToTarget() {
            ...
            if (!(!a || !l || !c)) {
                if (this !== r && this.layout && c && nr(this.options.animationType, this.layout.layoutBox, c.layoutBox)) {
                    l = this.target || R();
                ...
                $(a, l), ht(a, u), At(this.projectionDeltaWithTransform, this.layoutCorrected, a, u)
            }
        }
        ...
        resetSkewAndRotation() {
            ...
            for (let u = 0; u < ae.length; u++) le(`rotate${ae[u]}`, r, c, this.animationValues), le(`skew${ae[u]}`, r, c, this.animationValues);
            r.render();
        ...
        applyProjectionStyles(r, a) {
            ...
            if (this.needsReset) {
                this.needsReset = !1, r.visibility = "", r.opacity = "", r.pointerEvents = Nt(a ? .pointerEvents) || "", r.transform = l ? l(this.latestValues, "") : "none";
                return
            }
            const c = this.getLead();
            if (!this.projectionDelta || !this.layout || !c.target) {
                this.options.layoutId && (r.opacity = this.latestValues.opacity !== void 0 ? this.latestValues.opacity : 1, r.pointerEvents = Nt(a ? .pointerEvents) || ""), this.hasProjected && !et(this.latestValues) && (r.transform = l ? l({}, "") : "none", this.hasProjected = !1);
                return
            }
            r.visibility = "";
            const u = c.animationValues || c.latestValues;
            this.applyTransformsToTarget();
            let h = su(this.projectionDeltaWithTransform, this.treeScale, u);
            ...
            for (const m in we) {
                ...
                const {
                    ...
                    applyTo: y,
                    isCSSVariable: p
                } = we[m], T = h === "none" ? u[m] : v(u[m], c);
                if (y) {
                    const g = y.length;
                    for (let A = 0; A < g; A++) r[y[A]] = T
                } else p ? this.options.visualElement.renderState.vars[m] = T : r[m] = T
            }
            this.options.layoutId && (r.pointerEvents = c === this ? Nt(a ? .pointerEvents) || "" : "none")
        }
        clearSnapshot() {
...
function au(t) {
    ...
    if (t.isLead() && t.layout && e && t.hasListeners("didUpdate")) {
        ...
        At(r, n, e.layoutBox);
        const a = ft();
        o ? At(a, t.applyTransform(s, !0), e.measuredBox) : At(a, n, e.layoutBox);
        const l = !Ji(r);
        let c = !1;
        if (!t.resumeFrom) {
            ...
            if (u && !u.resumeFrom) {
                ...
                if (h && f) {
                    const d = R();
                    _t(d, e.layoutBox, h.layoutBox);
                    const m = R();
                    _t(m, n, f.layoutBox), Qi(d, m) || (c = !0), u.options.layoutRoot && (t.relativeTarget = m, t.relativeTargetOrigin = d, t.relativeParent = u)
                }
            }
        }
...
const vu = {
    ...
    Ps = t => typeof navigator < "u" && navigator.userAgent && navigator.userAgent.toLowerCase().includes(t),
    Ss = Ps("applewebkit/") && !Ps("chrome/") ? Math.round : W;
...
function nr(t, e, n) {
    return t === "position" || t === "preserve-aspect" && !Vl(ms(e), ms(n), .2)
}
...
class bu extends J {
    mount() {
        ...
        e && (this.unmount = Jo(e, (n, s) => (As(this.node, s, "Start"), i => As(this.node, i, "End"))))
    }
    unmount() {}
}
class Au extends J {
    ...
    mount() {
        this.unmount = Et(Dt(this.node.current, "focus", () => this.onFocus()), Dt(this.node.current, "blur", () => this.onBlur()))
    }
    unmount() {}
}
...
class wu extends J {
    mount() {
        ...
        e && (this.unmount = na(e, (n, s) => (ws(this.node, s, "Start"), (i, {
            success: o
        }) => ws(this.node, i, o ? "End" : "Cancel")), {
...
function Mu({
    ...
    const s = ce.get(n),
        i = JSON.stringify(e);
    return s[i] || (s[i] = new IntersectionObserver(Cu, {
        root: t,
        ...e
    })), s[i]
}
...
function Iu(t, e) {
    ...
    const n = new Map,
        ...
        i = (o, r) => s(o, r);
    return new Proxy(i, {
        get: (o, r) => r === "create" ? s : (n.has(r) || n.set(r, ne(r, void 0, t, e)), n.get(r))
    })
}
const Uu = Iu(Bu, Ya);
export {
    Us as L, Ws as M, on as P, Wl as a, Ra as b, Xo as i, Uu as m, Sa as u
};