        ...
        (function(m, g) {
            ...
            return (function(m) {
                ...
                return u.m = m, u.c = g, u.d = function(n, a, p) {
                    u.o(n, a) || Object.defineProperty(n, a, {
                        enumerable: !0,
                        get: p
                    })
                }, u.r = function(n) {
                    ...
                    if (u.r(p), Object.defineProperty(p, "default", {
                        ...
                        for (var S in n) u.d(p, S, (function(M) {
                            return n[M]
                        }).bind(null, S));
                    return p
                }, u.n = function(n) {
                ...
                "./src/react-webcam.tsx": (function(m, g, u) {
                    u.r(g);
                    var n = u("react"),
                        a = (function() {
                            var f = function(o, e) {
                        ...
                        S = function(f, o) {
                            ...
                            if (f != null && typeof Object.getOwnPropertySymbols == "function")
                                for (var i = 0, t = Object.getOwnPropertySymbols(f); i < t.length; i++) o.indexOf(t[i]) < 0 && Object.prototype.propertyIsEnumerable.call(f, t[i]) && (e[t[i]] = f[t[i]]);
                            return e
                        };
                    (function() {
                    ...
                    var _ = (function(f) {
                        ...
                        return o.prototype.componentDidMount = function() {
                            ...
                            var i = JSON.stringify(e.audioConstraints) !== JSON.stringify(t.audioConstraints),
                                r = JSON.stringify(e.videoConstraints) !== JSON.stringify(t.videoConstraints),
                                h = e.minScreenshotWidth !== t.minScreenshotWidth,
                                c = e.minScreenshotHeight !== t.minScreenshotHeight;
                            ...
                            var t = this,
                                i = t.state,
                                r = t.props;
                            if (!this.video || !i.hasUserMedia || !this.video.videoHeight) return null;
                            if (!this.ctx) {
                                var h = this.video.videoWidth,
                                ...
                                this.canvas = document.createElement("canvas"), this.canvas.width = e ? .width || h, this.canvas.height = e ? .height || c, this.ctx = this.canvas.getContext("2d")
                            }
                            var v = this,
                                l = v.ctx,
                                s = v.canvas;
                            return l && s && (s.width = e ? .width || s.width, s.height = e ? .height || s.height, r.mirrored && (l.translate(s.width, 0), l.scale(-1, 1)), l.imageSmoothingEnabled = r.imageSmoothing, l.drawImage(this.video, 0, 0, e ? .width || s.width, e ? .height || s.height), r.mirrored && (l.scale(-1, 1), l.translate(-s.width, 0))), s
                            ...
                            if ("mediaDevices" in navigator) i(t.audioConstraints, t.videoConstraints);
                            else {
                                var r = function(c) {
                                        return {
                                            optional: [{
                            ...
                            var d = r.mirrored,
                                ...
                                l = v === void 0 ? {} : v,
                                s = r.children,
                                y = S(r, ["audio", "forceScreenshotSourceSize", "disablePictureInPicture", "onUserMedia", "onUserMediaError", "screenshotFormat", "screenshotQuality", "minScreenshotWidth", "minScreenshotHeight", "audioConstraints", "videoConstraints", "imageSmoothing", "mirrored", "style", "children"]),
                                C = d ? p(p({}, l), {
                            ...
                            return n.createElement(n.Fragment, null, n.createElement("video", p({
                                autoPlay: !0,
